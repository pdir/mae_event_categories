 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_mae_event_cat']['new']    = array('Neue Kategorie ', 'Eine neue Kategorie anlegen');
$GLOBALS['TL_LANG']['tl_mae_event_cat']['show']   = array(' Details', 'Zeige Details von ID %s');
